...
ALT_THRESHOLD = 5
ALT_OUTPUT = Path(__file__).resolve().parent / "biaozhu_keys_freq_min5.txt"

# 默认标注目录（本地运行）：DAPT/biaozhu_data 下的五个文件
DEFAULT_ANNOT_DIR = Path(__file__).resolve().parent / "biaozhu_data"
DEFAULT_FILES = [
    "ruyuanjilu1119.json",
...
DEFAULT_OUTPUT = Path(__file__).resolve().parent / "biaozhu_keys_freq.txt"
