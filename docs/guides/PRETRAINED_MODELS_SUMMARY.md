...
- `DAPT/docs/pipelines/pipeline_new.md`：当前主预训练流程
...
| --- | --- | --- | --- |
| Main Full（主流程 KV-MLM + KV-NSP + Noise） | KV-aware MLM，全词掩码；带 Noise Embedding；带 KV-NSP staged 交替训练 | `train_dapt_macbert_staged.py` / `docs/pipelines/pipeline_new.md` | `/data/ocean/DAPT/workspace/output_macbert_kvmlm_staged/final_staged_model` |
...
- `compare_models.py --output_summary xxx.json` 会自动生成：
  - `xxx_preds.jsonl`
  - `xxx_gt.jsonl`
- 手工流程（`docs/pipelines/pipeline_xiaorong.md` 里的 `macbert / no_nsp / no_mlm / no_noise`）对齐文件一般使用：
...
- 主流程命令来源：`DAPT/docs/pipelines/pipeline_new.md`
- 关键特性：
  - `mlm_masking=kv_wwm`
  - 同时使用 MLM 和 KV-NSP
  - 使用噪声特征
...
来源文档：`DAPT/docs/pipelines/pipeline_new.md` 与 `DAPT/experiments/mlm_ablation/REMOTE_USAGE.md`
...
来源文档：`DAPT/docs/pipelines/pipeline_new.md` 与 `DAPT/experiments/noise_ablation/REMOTE_USAGE.md`
...
来源文档：`DAPT/docs/pipelines/pipeline_new.md` 与 `DAPT/experiments/nsp_ratio_ablation/REMOTE_USAGE.md`
...
- `DAPT/docs/pipelines/pipeline_new.md`
- `DAPT/experiments/noise_ablation/REMOTE_USAGE.md`
- `DAPT/experiments/mlm_ablation/REMOTE_USAGE.md`
- `DAPT/experiments/nsp_ratio_ablation/REMOTE_USAGE.md`
- `DAPT/docs/pipelines/pipeline_xiaorong.md`
- `DAPT/docs/pipelines/pipeline_task2_xiaorong.md`
...
仍指向旧路径。若你后续以 `docs/pipelines/pipeline_new.md` 为主，建议统一改到新的主流程目录。
