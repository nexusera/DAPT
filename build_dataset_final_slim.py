...
DEFAULT_TOKENIZER_PATH = os.path.join(DEFAULT_WORKSPACE_DIR, "my-medical-tokenizer")
# 使用重采样+滑窗后的语料
...
DEFAULT_VOCAB_FOR_JIEBA = os.path.join(DEFAULT_WORKSPACE_DIR, "vocab_for_jieba.txt") # WordPiece 挖掘的高频词
