...
示例用法:
  # 使用默认阈值（10次）
  python scripts/analysis/analyze_key_frequency.py --input /data/ocean/DAPT/data/pseudo_kv_labels_filtered.json
  
  # 自定义阈值
  python scripts/analysis/analyze_key_frequency.py --input /data/ocean/DAPT/data/pseudo_kv_labels_filtered.json --min_freq 5
  
  # 输出到指定文件
  python scripts/analysis/analyze_key_frequency.py --input /data/ocean/DAPT/data/pseudo_kv_labels_filtered.json --output keys_filtered.txt
        """
    )
