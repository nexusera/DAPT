...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Compatibility wrapper that forwards to the official MedStruct-S scorer."
    )
    ...
    print(
        "[DEPRECATED] experiments/scorer.py now forwards to the official MedStruct-S scorer.",
        file=sys.stderr,
    )
