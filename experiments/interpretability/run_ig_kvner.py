    ...
    with out_path.open("w", encoding="utf-8") as fout:
        for row in total:
            ...
            if args.compute_faithfulness:
                ...
                deleted_ids = _apply_token_perturbation(input_ids, baselines, selected_idx, mode="delete")
                kept_ids = _apply_token_perturbation(input_ids, baselines, selected_idx, mode="keep")
